...
class Game:
    ...
    def __init__(self, scene_manager):
        ...
        self.GAME_FONT = pygame.freetype.Font(
            "Fonts/HighlandGothicFLF-Bold.ttf", Settings.FONT_SIZE
        )
    ...
    def render(self):
        ...
        text_surface, rect = self.GAME_FONT.render(
            "Dice 1:  " + str(self.num1), (0, 0, 0)
        )
        self.screen.blit(text_surface, (10, 10))
        # or just `render_to` the target surface.
        self.GAME_FONT.render_to(
            self.screen, (10, 30), "Dice 2: " + str(self.num2), (0, 0, 0)
        )

        self.GAME_FONT.render_to(self.screen, (10, 250), self.result, (0, 0, 0))
        self.GAME_FONT.render_to(
            self.screen, (10, 350), "Press SPACE to roll", (0, 0, 0)
        )
        self.GAME_FONT.render_to(
            self.screen,
            (10, 370),
            "Press Num key for player (P1 == 1) to cash out of the round",
            (0, 0, 0),
        )
        self.GAME_FONT.render_to(
            self.screen, (10, 395), "Press S for scene selection", (0, 0, 0)
        )
        ...
        self.GAME_FONT.render_to(
            ...
            (10, 500),
            "P1: "
            + str(self.p1.tmpScore)
            + "   P2: "
            + str(self.p2.tmpScore)
            + "   P3: "
            + str(self.p3.tmpScore)
            + "   P4: "
            + str(self.p4.tmpScore),
            (0, 0, 0),
        )
        ...
        self.GAME_FONT.render_to(
            ...
            "Finishline Score: "
            + str(self.winScore)
            + " (Highest Score Past Finish Line Wins!)",
            (0, 0, 0),
        )
